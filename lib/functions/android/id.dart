...
class _IdWidgetState extends State<IdWidget> {
  ...
  Future<void> getId() async {
    try {
      ...
      setState(() {
        _id = context.tr('unknownOrNotAndroidNotice');
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(context.tr('idLongName')),
        actions: [
          IconButton(
            ...
            onPressed: () {
              showModalBottomSheet(
                  ...
                  builder: (context) => InfoModalBottomSheet(
                      name: context.tr('idLongName'),
                      description: context.tr('idLongDescription'),
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            Text(_id, style: const TextStyle(fontSize: 24)),
          ],
        ),
      ),
    );
