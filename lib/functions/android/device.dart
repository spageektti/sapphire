...
class _DeviceWidgetState extends State<DeviceWidget> {
  ...
  Future<void> getDevice() async {
    try {
      ...
      setState(() {
        _device = context.tr('unknownOrNotAndroidNotice');
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(context.tr('deviceLongName')),
        actions: [
          IconButton(
            ...
            onPressed: () {
              showModalBottomSheet(
                  ...
                  builder: (context) => InfoModalBottomSheet(
                      name: context.tr('deviceLongName'),
                      description: context.tr('deviceLongDescription'),
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            Text(_device, style: const TextStyle(fontSize: 24)),
          ],
        ),
      ),
    );
