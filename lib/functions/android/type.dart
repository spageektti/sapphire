...
class _TypeWidgetState extends State<TypeWidget> {
  ...
  Future<void> getType() async {
    try {
      ...
      setState(() {
        _type = context.tr('unknownOrNotAndroidNotice');
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(context.tr('typeLongName')),
        actions: [
          IconButton(
            ...
            onPressed: () {
              showModalBottomSheet(
                  ...
                  builder: (context) => InfoModalBottomSheet(
                      name: context.tr('typeLongName'),
                      description: context.tr('typeLongDescription'),
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            Text(_type, style: const TextStyle(fontSize: 24)),
          ],
        ),
      ),
    );
