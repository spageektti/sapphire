...
class Sha256ChecksumGeneratorWidget extends StatefulWidget {
  const Sha256ChecksumGeneratorWidget({super.key});

  @override
  State<Sha256ChecksumGeneratorWidget> createState() =>
      _Sha256ChecksumGeneratorWidgetState();
}

class _Sha256ChecksumGeneratorWidgetState
    extends State<Sha256ChecksumGeneratorWidget> {
  String? _checksum;
  String? _filePath;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(context.tr('sha256ChecksumGeneratorLongName')),
        actions: [
          IconButton(
            ...
            onPressed: () {
              showModalBottomSheet(
                  ...
                  builder: (context) => InfoModalBottomSheet(
                      name: context.tr('sha256ChecksumGeneratorLongName'),
                      description:
                          context.tr('sha256ChecksumGeneratorLongDescription'),
          ...
          children: [
            ...
            if (_checksum != null)
              Row(
                children: [
                  SelectableText(
                    context.tr('sha256ChecksumLabel',
