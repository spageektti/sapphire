...
class Md5ChecksumGeneratorWidget extends StatefulWidget {
  const Md5ChecksumGeneratorWidget({super.key});

  @override
  State<Md5ChecksumGeneratorWidget> createState() =>
      _Md5ChecksumGeneratorWidgetState();
}

class _Md5ChecksumGeneratorWidgetState
    extends State<Md5ChecksumGeneratorWidget> {
  String? _checksum;
  String? _filePath;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(context.tr('md5ChecksumGeneratorLongName')),
        actions: [
          IconButton(
            ...
            onPressed: () {
              showModalBottomSheet(
                  ...
                  builder: (context) => InfoModalBottomSheet(
                      name: context.tr('md5ChecksumGeneratorLongName'),
                      description:
                          context.tr('md5ChecksumGeneratorLongDescription'),
