...
class Sha512ChecksumGeneratorWidget extends StatefulWidget {
  const Sha512ChecksumGeneratorWidget({super.key});

  @override
  State<Sha512ChecksumGeneratorWidget> createState() =>
      _Sha512ChecksumGeneratorWidgetState();
}

class _Sha512ChecksumGeneratorWidgetState
    extends State<Sha512ChecksumGeneratorWidget> {
  String? _checksum;
  String? _filePath;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(context.tr('sha512ChecksumGeneratorLongName')),
        actions: [
          IconButton(
            ...
            onPressed: () {
              showModalBottomSheet(
                  ...
                  builder: (context) => InfoModalBottomSheet(
                      name: context.tr('sha512ChecksumGeneratorLongName'),
                      description:
                          context.tr('sha512ChecksumGeneratorLongDescription'),
          ...
          children: [
            ...
            if (_checksum != null)
              Row(
                children: [
                  SelectableText(
                    context.tr('sha512ChecksumLabel',
