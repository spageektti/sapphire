...
class Sha224ChecksumGeneratorWidget extends StatefulWidget {
  const Sha224ChecksumGeneratorWidget({super.key});

  @override
  State<Sha224ChecksumGeneratorWidget> createState() =>
      _Sha224ChecksumGeneratorWidgetState();
}

class _Sha224ChecksumGeneratorWidgetState
    extends State<Sha224ChecksumGeneratorWidget> {
  String? _checksum;
  String? _filePath;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(context.tr('sha224ChecksumGeneratorLongName')),
        actions: [
          IconButton(
            ...
            onPressed: () {
              showModalBottomSheet(
                  ...
                  builder: (context) => InfoModalBottomSheet(
                      name: context.tr('sha224ChecksumGeneratorLongName'),
                      description:
                          context.tr('sha224ChecksumGeneratorLongDescription'),
          ...
          children: [
            ...
            if (_checksum != null)
              Row(
                children: [
                  SelectableText(
                    context.tr('sha224ChecksumLabel',
