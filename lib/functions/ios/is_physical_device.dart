...
class _IsPhysicalDeviceWidgetState extends State<IsPhysicalDeviceWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(context.tr('iosisPhysicalDeviceLongName')),
        actions: [
          IconButton(
            ...
            onPressed: () {
              showModalBottomSheet(
                  ...
                  builder: (context) => InfoModalBottomSheet(
                      name: context.tr('iosisPhysicalDeviceLongName'),
                      description:
                          context.tr('iosisPhysicalDeviceLongDescription'),
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            Text(
              _isPhysicalDevice ? context.tr('yes') : context.tr('no'),
