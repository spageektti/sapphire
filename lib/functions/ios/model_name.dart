...
class ModelNameWidget extends StatefulWidget {
  const ModelNameWidget({super.key});

  @override
  _ModelNameWidgetState createState() => _ModelNameWidgetState();
}

class _ModelNameWidgetState extends State<ModelNameWidget> {
  String _modelName = "";

  Future<void> getModelName() async {
    try {
      DeviceInfoPlugin deviceInfo = DeviceInfoPlugin();
      IosDeviceInfo iosInfo = await deviceInfo.iosInfo;
      setState(() {
        _modelName = iosInfo.modelName;
      });
    } catch (e) {
      setState(() {
        _modelName = context.tr('unknownOrNotIosNotice');
      });
    }
  }
