...
class _ModelWidgetState extends State<ModelWidget> {
  ...
  Future<void> getModel() async {
    try {
      ...
      setState(() {
        _model = context.tr('unknownOrNotIosNotice');
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(context.tr('iosmodelLongName')),
        actions: [
          IconButton(
            ...
            onPressed: () {
              showModalBottomSheet(
                  ...
                  builder: (context) => InfoModalBottomSheet(
                      name: context.tr('iosmodelLongName'),
                      description: context.tr('iosmodelLongDescription'),
